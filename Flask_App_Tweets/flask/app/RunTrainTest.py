...
def get_expert_tweets(article_url): 
	...
	if cat_dict['return_val'] == 1: 
		...
		if user_dict['return_val'] == 1: 
			...
			print "Stage 4: Found Pundit Tweets"
			return pundit_tweets
	else: 
		return "This was not a science article"

def flask_main(article_url): 
	pundit_tweets = get_expert_tweets(article_url)
	return pundit_tweets
